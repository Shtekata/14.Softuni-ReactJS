...
import x from './Counter.module.css';
    ...
    render() {
        return (
            <div className="counter">
                ...
                <button className={x.button} onClick={(e)=>this.setState({count:this.state.count+1})}>+</button>
                <button className={x.button} onClick={()=>this.incrementCount()}>+</button>
